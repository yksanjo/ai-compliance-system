...
export class ViolationDetector {
     ...
     */
    async checkAsset(identifier, type, policies) {
        const violations = [];
     ...
     */
    checkCertificate(cert, policies) {
        const violations = [];
        // Check expiration
     ...
     */
    addRemediation(violationId, remediation) {
...
//# sourceMappingURL=violation-detector.js.map